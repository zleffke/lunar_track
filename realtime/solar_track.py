...
def Lunar_Rise_Set(e, gs, t0=None, t1=None):
    ...
    #print(t0)
    #print(t1)
    f = almanac.risings_and_settings(e, e['Sun'], gs)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Real Time Solar Tracking",
    ...
    cfg.add_argument('--cfg_file',
                       dest='cfg_file',
                       type=str,
                       default="lunar_track_config.json",
    ...
    try:
        while True:
            ...
            astrometric = (e['earth']+gs).at(t).observe(e['sun'])
            alt, az, d = astrometric.apparent().altaz()
            t_c = d.km * 1000 / c
            lunar_illum = Lunar_Illumination(e, t)
            #print(alt.degrees, az.degrees, d.km, time_to_set)
            if rise_set['vis']: print("Sun is Visible!")
            else: print("Sun is below horizon")
            ...
            print("       Time to Sun Rise:", time_to_rise)
